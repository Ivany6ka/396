        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              <h4>Покупки в удовольствие</h4>
              <h1>Для наших покупателей акции</h1>
              <p>Получить скидку 20% при первой покупке.</p>
              <a class="button button-hero" href="/register">Зарегистрироваться и купить</a>
            </div>
          </div>
        </div>
      </div>
